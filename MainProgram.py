...
# Import the new FluentWindow class
from UIProgram.UiMain import PCBWindow
...
class MainWindow(PCBWindow):
    def __init__(self):
        # Initialize parent (PCBWindow/FluentWindow)
        super().__init__()
    ...
    def initMain(self):
        ...
        # self.tableWidget.verticalHeader().setVisible(False)  # 隐藏列标题 (Done in UiMain)
    ...
    def open_img(self):
        ...
        # self.comboBox.setDisabled(False) # Fluent ComboBox uses setEnabled
